...
export const ChartCard = memo(() => (
    <>
        <CardWrapper
            outerDivClassName="mb-6 lg:mb-0 lg:w-5/12 mt-0"
            innerDivClassName="z-20"
        >
                        ...
                        {CHART_METRICS.map((metric, index) => (
                            ...
                            >
                                <div className="flex mb-2">
                                    <div className={`flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl ${metric.color} text-neutral-900`}>
                                        <FontAwesomeIcon
                                            icon={metric.icon}
                                            className="text-white text-sm"
                                        />
                                    </div>
                                    <p className="mt-1 mb-0 text-xs font-semibold leading-tight">{metric.label}</p>
                                </div>
        ...
        <CardWrapper
            outerDivClassName="lg:w-7/12 mt-0"
            innerDivClassName="z-20"
        >
            <CardHeaderWrapper>
